...
INSERT INTO "CPSAA"."GESAC_DET_PERM_ROL"("SCDPR_IDE_PERM_ROL_K", "SCMAP_IDE_PERM_K", "SCMAR_IDE_ROL_K","SCDPR_FLG_ELI", "SCDPR_COC_EST")
    VALUES ((SELECT nextval('"CPSAA"."GESAC_SEQ_ID_DET_PERM_ROL"') from "CPSAA"."GESAC_SEQ_ID_DET_PERM_ROL"), (SELECT MAX("SCMAP_IDE_PERM_K") FROM "CPSAA"."GESAC_MAE_PERM"), 26,'N', 'ACT');


INSERT INTO "CPSAA"."GESAC_DET_PERM_ROL"("SCDPR_IDE_PERM_ROL_K", "SCMAP_IDE_PERM_K", "SCMAR_IDE_ROL_K","SCDPR_FLG_ELI", "SCDPR_COC_EST")
    VALUES ((SELECT nextval('"CPSAA"."GESAC_SEQ_ID_DET_PERM_ROL"') from "CPSAA"."GESAC_SEQ_ID_DET_PERM_ROL"), (SELECT MAX("SCMAP_IDE_PERM_K") FROM "CPSAA"."GESAC_MAE_PERM"), 4,'N', 'ACT');
...
INSERT INTO "CPSAA"."GESAC_SYS_TABL_GENE"("SCSTG_IDE_TAB_GEN_K", "SCSTG_COD_TAB_GEN", "SCSTG_COD_LLA_TAB", "SCSTG_NRO_ORD", "SCSTG_NOM_TAB", "SCSTG_NOM_TAB_MOS", "SCSTG_GLS_DES") VALUES ((SELECT nextval('"CPSAA"."GESAC_SEQ_ID_SYS_LOG_TABL"') from "CPSAA"."GESAC_SEQ_ID_SYS_LOG_TABL"),'ACCAUD','REE', 4, NULL,'Reemplazo', null);