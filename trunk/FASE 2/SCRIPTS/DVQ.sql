...
INSERT INTO "CPSAA"."GESAC_MAE_ROL"(
    ...
    VALUES ((SELECT nextval('"CPSAA"."GESAC_SEQ_ID_ROL"') from "CPSAA"."GESAC_SEQ_ID_ROL"), 'Responsable de Administración de Datos', 'Tendrá acceso a todos los mantenimientos del Administrar Datos', 'ACT');
