-- ADMINISTRAR MATRIZ DE TRATAMIENTO
alter table "CPSAA"."GESAC_MAE_MATR_TRAT" add "SCMMT_FCH_HOR_REG" timestamp without time zone;



-- ADMINISTRAR GRUPO TIPO DE ENSAYO
alter table "CPSAA"."GESAC_MAE_GRUP_TIPO_ENSA" add "SCMMT_FCH_HOR_REG" timestamp without time zone;


INSERT INTO "CPSAA"."GESAC_SYS_TABL_GENE"(
    "SCSTG_IDE_TAB_GEN_K", "SCSTG_COD_TAB_GEN", "SCSTG_COD_LLA_TAB", 
     "SCSTG_NOM_TAB", "SCSTG_NOM_TAB_MOS", "SCSTG_GLS_DES")
VALUES ((SELECT coalesce(max(SYS."SCSTG_IDE_TAB_GEN_K"),0) + 1 FROM "CPSAA"."GESAC_SYS_TABL_GENE" SYS), 'CGTTE', 'RCE', 
    '', 'Resistencia de cemento', 'Resistencia de cemento');
...
-- ADMINISTRAR EMPRESA
alter table "CPSAA"."GESAC_MAE_EMPR" add "SCMAE_COC_EST" character varying(3);
update "CPSAA"."GESAC_MAE_EMPR" set "SCMAE_COC_EST" = 'ACT';


-- ADMINISTRAR NEGOCIO
alter table "CPSAA"."GESAC_MAE_NEGO" add "SCMAN_COC_EST" character varying(3);
...
-- ADMINISTRAR GRUPO DE MUESTRA QCX
...
-- ADMINISTRAR ID DE LOTES Y ENSAYOS
...
-- GESTION DE STOCK DE PRE-FABRICADOS DINO
